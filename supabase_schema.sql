...
CREATE TABLE user_profiles (
  ...
  body_photo_front TEXT         NOT NULL DEFAULT '',
  body_photo_left  TEXT         NOT NULL DEFAULT '',
  body_photo_right TEXT         NOT NULL DEFAULT '',
  body_photo_back  TEXT         NOT NULL DEFAULT '',
