                ...
                child: Column(
                  children: [
                    _SettingsRow(
                      ...
                      trailing: Consumer(builder: (_, ref2, __) {
                        final dm = ref2.watch(themeModeProvider) == ThemeMode.dark;
                        return GestureDetector(
                          onTap: () => ref2.read(themeModeProvider.notifier).toggleThemeMode(),
                          child: AnimatedContainer(
                            duration: const Duration(milliseconds: 200),
                            width: 42, height: 24,
                            decoration: BoxDecoration(
                              color: dm ? green : const Color(0xFFD0D0CE),
                              borderRadius: BorderRadius.circular(12),
                            ),
                            child: AnimatedAlign(
                              duration: const Duration(milliseconds: 200),
                              alignment: dm ? Alignment.centerRight : Alignment.centerLeft,
                              child: Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 2),
                                child: Container(
                                  width: 20, height: 20,
                      ...
                      color: const Color(0xFFF59E0B),
                      ink: ink, muted: muted, isFirst: true, isLast: false,
                      isDark: isDarkMode,
                    ),
                    Divider(height: 1, color: isDarkMode ? const Color(0xFF2A2A2A) : const Color(0xFFF0F0EE)),
                    _SettingsRow(
                      icon: LucideIcons.languages,
                      label: isFr ? 'Langue' : 'Language',
                      trailing: Consumer(builder: (_, ref2, __) {
                        final fr = ref2.watch(localeProvider).languageCode == 'fr';
                        return GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: isDarkMode ? const Color(0xFF2A2A2A) : const Color(0xFFF0F0EE),
                            ...
                            child: Row(
                              ...
                              children: [
                                AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    color: fr ? green : Colors.transparent,
                                    borderRadius: BorderRadius.circular(7),
                                  ),
                                  child: Text('FR', style: TextStyle(
                                    fontSize: 12, fontWeight: FontWeight.w700,
                                    color: fr ? Colors.white : muted)),
                                ),
                                AnimatedContainer(
                                  duration: const Duration(milliseconds: 200),
                                  padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                      ...
                      color: const Color(0xFF6366F1),
                      ink: ink, muted: muted, isFirst: false, isLast: false,
                      isDark: isDarkMode,
                    ),
                    Divider(height: 1, color: isDarkMode ? const Color(0xFF2A2A2A) : const Color(0xFFF0F0EE)),
                    _SettingsRow(
                      ...
                      ink: ink, muted: muted, isFirst: false, isLast: true,
                      isDark: isDarkMode,
                      onTap: () async {
