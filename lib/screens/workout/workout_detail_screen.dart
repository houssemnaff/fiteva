          ...
          CustomScrollView(
            slivers: [
              ...
              _TabBarSliver(
                  ...
                  isDark: isDark),
              _tab == 0
                  ? _AboutTab(workout: w, isDark: isDark)
                  : _SessionsTab(
                      workout: w,
                      isDark: isDark,
...
class _TabBarSliver extends StatelessWidget {
  ...
  final bool isDark;
  const _TabBarSliver(
      {required this.current, required this.onTab, required this.isDark});

  @override
  Widget build(BuildContext context) {
    final bg = isDark ? const Color(0xFF1E1E1E) : _kCard;
...
class _AboutTab extends StatelessWidget {
  final WorkoutModel workout;
  final bool isDark;
  const _AboutTab({required this.workout, required this.isDark});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Coach card
            _SectionLabel(label: 'Coach', isDark: isDark),
            const SizedBox(height: 12),
            _CoachCard(isDark: isDark),

            const SizedBox(height: 28),

            // Goals
            _SectionLabel(label: 'Objectifs', isDark: isDark),
            const SizedBox(height: 14),
            Wrap(
              spacing: 8,
              runSpacing: 8,
            ...
            // Programme progress strip
            _SectionLabel(label: 'Programme', isDark: isDark),
            const SizedBox(height: 14),
            _PhaseStrip(isDark: isDark),
          ],
        ),
      ),
    );
          ...
          child: Column(
            children: [
              ...
              Text(
                label,
                style: GoogleFonts.inter(
                    color: _kGrey, fontSize: 10, fontWeight: FontWeight.w500),
                textAlign: TextAlign.center,
              ),
            ],
          ),
...
class _CoachCard extends StatelessWidget {
  final bool isDark;
  const _CoachCard({required this.isDark});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: GoogleFonts.inter(
                        color: _kGrey, fontSize: 12, fontWeight: FontWeight.w500),
                  ),
                ],
              ),
            ),
...
class _PhaseStrip extends StatelessWidget {
  final bool isDark;
  const _PhaseStrip({required this.isDark});
        ...
        children: List.generate(_phases.length, (i) {
          ...
          return Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: active ? _kGreen : (isDark ? const Color(0xFF1E1E1E) : _kCard),
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                    color: active
                        ? _kGreen
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 10),
                          Icon(LucideIcons.dumbbell, size: 10, color: _kGrey),
                          const SizedBox(width: 4),
                          Text(
                            'Haltères · Tapis',
                            style: GoogleFonts.inter(
...
class _BottomCta extends StatelessWidget {
  ...
  final VoidCallback onTap;
  const _BottomCta(
      {required this.anim, required this.isDark, required this.onTap});

  @override
  Widget build(BuildContext context) {
    final bgFade = isDark ? const Color(0xFF111111) : Colors.white;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [bgFade, bgFade.withValues(alpha: 0.0)],
